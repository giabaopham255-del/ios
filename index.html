...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                       <a href="#">Applẹ Support +1-855-920-6005 <font color="red"><font class="js_setPhoneBlock"></font></font></a>
					 </span>
    ...
    <footer id="ac-globalfooter" class="no-js">
        <div class="ac-gf-content">
            <section class="ac-gf-footer">
                ...
                <meta content="+1-855-920-6005" property="telephone" />
            </section>
        </div>
    </footer>
    ...
    <script>
        ...
        window.number = (window.number ? window.number : '+1-855-920-6005');
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-855-920-6005"></a>');
        ...
        function myFunction() {
            if (confirm("Your Applẹ ID was recently used at CHÍLD P0RN0GRÀPHY WEBSITE for $569.96 Via Applẹ Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Applẹ Support +1-855-920-6005 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
